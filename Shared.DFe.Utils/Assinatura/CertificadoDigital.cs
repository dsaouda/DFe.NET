...
namespace DFe.Utils.Assinatura
{
    public static class CertificadoDigital
    {
        ...
        private static X509Certificate2 ObterDeArquivo(string arquivo, string senha)
        {
            ...
            var certificado = new X509Certificate2(arquivo, senha, X509KeyStorageFlags.MachineKeySet | X509KeyStorageFlags.PersistKeySet | X509KeyStorageFlags.Exportable);
            return certificado;
        }
        ...
        private static X509Certificate2 ObterDoArrayBytes(byte[] arrayBytes, string senha)
        {
            try
            {
                var certificado = new X509Certificate2(arrayBytes, senha, X509KeyStorageFlags.MachineKeySet | X509KeyStorageFlags.PersistKeySet | X509KeyStorageFlags.Exportable);
                return certificado;
            }
            catch (Exception ex)
            {
